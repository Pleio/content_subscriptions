...
$language = array (
  ...
  'content_subscriptions:sidebar:notifications' => 'Je blijft al op de hoogte door je groep notificatie instellingen.',
  'content_subscriptions:sidebar:counter' => '%s leden volgen dit.',
  'content_subscriptions:sidebar:no_subscriptions' => 'Niemand volgt dit.',
  'content_subscriptions:subscribe:description' => 'Als je op de hoogte wilt blijven van deze content, klik Volgen',
  'content_subscriptions:unsubscribe:description' => 'Als je niet langer op de hoogte wilt blijven van deze content, klik Ontvolgen.',
